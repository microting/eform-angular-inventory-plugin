...
# Define paths
src_base = os.path.join("Documents", "workspace", "microting", "eform-angular-inventory-plugin")
dst_base = os.path.join("Documents", "workspace", "microting", "eform-angular-frontend")

# Remove and copy directories
paths = [
    (os.path.join("eform-client", "src", "app", "plugins", "modules", "inventory-pn"),
     os.path.join("eform-client", "src", "app", "plugins", "modules", "inventory-pn")),
    (os.path.join("eFormAPI", "Plugins", "Inventory.Pn"),
     os.path.join("eFormAPI", "Plugins", "Inventory.Pn")),
]
...
test_files_to_remove = [
    os.path.join("eform-client", "e2e", "Tests", "inventory-settings"),
    os.path.join("eform-client", "e2e", "Tests", "inventory-general"),
    os.path.join("eform-client", "e2e", "Page objects", "Inventory"),
